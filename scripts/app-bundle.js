define('validation-renderer',["require", "exports"], function (require, exports) {
    ...
    var FormValidationRenderer = (function () {
        ...
        FormValidationRenderer.prototype.add = function (element, error) {
            var formGroup = element.closest('td');
            if (!formGroup) {
                return;
            }
        ...
        FormValidationRenderer.prototype.remove = function (element, error) {
            var formGroup = element.closest('td');
            if (!formGroup) {
                return;
            }
...
define('app',["require", "exports", "aurelia-validation", "./validation-renderer", "./person"], function (require, exports, aurelia_validation_1, validation_renderer_1, person_1) {
    "use strict";
    var App = (function () {
        function App(validationControllerFactory) {
            ...
            this.validationController.addRenderer(new validation_renderer_1.FormValidationRenderer());
            this.person = new person_1.Person();
            this.validationController.reset();
        }
        App.inject = function () { return [aurelia_validation_1.ValidationControllerFactory]; };
        App.prototype.bind = function () {
            aurelia_validation_1.ValidationRules
                .ensure(function (p) { return p.name; }).displayName("Name of person").required().maxLength(20)
                .ensure(function (p) { return p.email; }).displayName("Emailaddress").required().email().maxLength(30)
                .on(this.person);
        };
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"./styles.css\"></require>\n  <h1>Aurelia Validation</h1>\n  <form>\n    <ul if.bind=\"validationController.errors\">\n      <li repeat.for=\"error of validationController.errors\">\n        ${error.message}\n      </li>\n    </ul>\n    <div if.bind=\"valid\">\n      Form entries valid.\n    </div>\n    <table>\n      <tr>\n        <td>Name:</td>\n        <td><input type=\"text\" value.bind=\"person.name & validate\"/></td>\n      </tr>\n      <tr>\n        <td>Email:</td>\n        <td><input type=\"text\" value.bind=\"person.email & validate\"/></td>\n      </tr>\n      <tr>\n          <td><button type=\"submit\" click.delegate=\"submit()\">Submit</button></td>\n      </tr>      \n    </table>\n  </form>\n</template>"; });
define('text!styles.css', ['module'], function(module) { module.exports = ".has-error {\r\n    color: red;\r\n}"; });
